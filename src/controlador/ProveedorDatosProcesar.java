...
public class ProveedorDatosProcesar {
    ...
    public ArrayList<TimbradoProveedor> procesarTimbradoProveedor(ArrayList<String[]> csvArray, ArrayList<Proveedor> lProveedores) throws ParseException {
        ...
        for (String[] x : csvArray) {
            ...
            for (Sucursal s : prov.getSucursales()) {
                ...
                if (s.getCodigoEstablecimiento().compareTo(codFactura[0].trim()) == 0) {
    ...
    public ArrayList<Comprobante> procesarComprobanteProveedor(ArrayList<String[]> csvArray,
        ...
        for (String[] x : csvArray) {
            ...
            //seccion anexar a comprovante existente
            long timbradoID = 0L;
            ...
            if (timbradoID != 0L) {
                ...
                boolean encontroComprobante = false;
                ...
                for (Comprobante comp : out) {
                    ...
                    if (comp.getTimbradoProveedor().longValue() == timbradoID
                        ...
                        for (MontoImponible mi2 : comp.getMontosImponibles()) {
                            ...
                            if (iva2.longValue() == 0 && mi2.getTipoImpuesto() == 3L) {

                                mi2.setBaseImponible(mi2.getBaseImponible() + saldo);
                                mi2.setTotal(mi2.getTotal() + saldo);
                                mi2.setTotalView(mi2.getTotal() + "");
                                mi2.setBaseImponibleView(mi2.getBaseImponible() + "");
                                encontroMontoImponible2 = true;
                                break;
                            }

                            if (iva2.longValue() == 10 && mi2.getTipoImpuesto() == 1L) {
                                ...
                                Double valor = Precision.round((saldo / 11), decimal);
                                mi2.setBaseImponible(mi2.getBaseImponible() + (saldo - valor));
                                mi2.setValor(mi2.getValor() + valor);
                                mi2.setTotal(mi2.getTotal() + saldo);
                                mi2.setTotalView(mi2.getTotal() + "");
                                mi2.setBaseImponibleView(mi2.getBaseImponible() + "");
                                encontroMontoImponible2 = true;
                            ...
                            if (iva2.longValue() == 5 && mi2.getTipoImpuesto() == 2L) {
                                ...
                                Double valor = Precision.round((saldo / 21), decimal);
                                mi2.setBaseImponible(mi2.getBaseImponible() + (saldo - valor));
                                mi2.setValor(mi2.getValor() + valor);
                        ...
                        if (!encontroMontoImponible2) {
                            ...
                            if (iva2.longValue() == 10) {
                                ...
                                Double valor = Precision.round((saldo / 11), decimal);
                                mi2.setBaseImponible((saldo - valor));
                                mi2.setValor(valor);
