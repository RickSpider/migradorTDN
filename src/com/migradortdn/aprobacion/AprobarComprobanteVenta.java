 ...
 * @author BlackSpider
 */
public class AprobarComprobanteVenta {
     ...
     public static void main(String[] args) throws IOException{
        ...
        for (int i = 0; i<lComprobantesVenta.size(); i++){
            ...
            cola.add(new Long(lComprobantesVenta.get(i).getId()));
        ...
        for (int i = 0 ; i < hilos ; i++ ){
            ...
            Hilo hilo = new Hilo("Hilo"+i, rToken.getAccessToken(),Config.APROBARVENTA);
